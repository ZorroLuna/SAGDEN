...
<!-- jQuery -->
    ...
    <!-- Carrousel-->
		...
		<script src="js/autoplay.js" defer></script>
                ...
                <!-- IPN JS -->
                <!-- Menu Script  -->
	<script type="text/javascript" src="//www.ipn.mx/Style%20Library/scripts/jquery-latest.min.js"></script>
	<script type="text/javascript" src="//www.ipn.mx/Style%20Library/scripts/modernizr.custom.js"></script>
	<script type="text/javascript" src="//www.ipn.mx/Style%20Library/scripts/general.js"></script>
	<script type="text/javascript" src="//www.ipn.mx/Style%20Library/scripts/fortmas.js"></script>
